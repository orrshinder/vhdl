...
# ----------------------------------------
# If clock_generator is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2023.01.04.17:59:25
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clock_generator"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_generator.vho"
}
